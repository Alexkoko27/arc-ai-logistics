  ...
  return (
    <main className="mx-auto max-w-6xl space-y-10 px-6 py-10">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          {milestones.map((milestone) => (
            <div className="space-y-2 border border-gray-200 p-4" key={milestone.title}>
      ...
      <section className="space-y-4 border border-gray-200 p-5">
        ...
        <p className="text-gray-700">
          Short walkthrough of Arc AI Logistics — a multi-agent freight
          coordination demo powered by Circle and Arc.
        </p>
        <p className="text-gray-700">
          The video demonstrates how AI agents evaluate shipment opportunities
          using GPS data, route intelligence, economics, and risk analysis, then
          coordinate a USDC-denominated paid agent run with on-chain proof
          simulation.
        </p>
        <video
